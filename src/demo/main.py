...
source = EntsoeDayAheadTariffSource(country_code="NL", api_key=environment.get("ENTSOE_API_KEY", ""))
...
fr_tariffs = TariffApp(settings={"country_code": "FR", "api_key": environment.get("ENTSOE_API_KEY", ""), "name": "fr_tariffs"})
